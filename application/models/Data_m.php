...
class Data_m extends CI_Model {
    ...
    {
        return $this->db->update('tb_tamu', ['status' => 'LAMA'], ['id' => $id]);
    }

    var $kolom_order_tamu = array(null, 'nama', 'alamat', 'uang', 'beras', 'keterangan', 'dibuat', 'status');
    ...
    function get_datatables_tamu($kampung) {
        $this->_get_datatables_tamu();
        $this->db->like('alamat', $kampung, 'both');
    ...
    function count_filtered_tamu($kampung) {
        $this->_get_datatables_tamu();
        $this->db->like('alamat', $kampung, 'both');
        $query = $this->db->get();
        return $query->num_rows();
    }
    function count_all_tamu($kampung) {
        $this->db->from('tb_tamu');
        $this->db->like('alamat', $kampung, 'both');
